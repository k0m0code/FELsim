        ...
        for i in range(len(beamSegments)):
            ...
            if isinstance(beamSegments[i], driftLattice):
                while intTrack >= interval:
                    matrixVariables = np.array(beamSegments[i].getDriftMatrice(matrixVariables, length = interval))
                ...
                if intTrack > 0:
                    matrixVariables = np.array(beamSegments[i].getDriftMatrice(matrixVariables, length = intTrack))
                    xUpdated.append(np.std(matrixVariables[:,0]))
                    yUpdated.append(np.std(matrixVariables[:,2]))
                    xMean.append(np.mean(matrixVariables[:,0]))
                    yMean.append(np.mean(matrixVariables[:,2]))
            ...
            if isinstance(beamSegments[i], qpfLattice):
                while intTrack >= interval:
                    matrixVariables = np.array(beamSegments[i].getQPFmatrice(matrixVariables, length = interval))
                    xUpdated.append(np.std(matrixVariables[:,0]))
                    yUpdated.append(np.std(matrixVariables[:,2]))
                    xMean.append(np.mean(matrixVariables[:,0]))
                    yMean.append(np.mean(matrixVariables[:,2]))
                    ...
                    x_axis.append(round(x_axis[-1]+interval, 3))
                if intTrack > 0:
                    matrixVariables = np.array(beamSegments[i].getQPFmatrice(matrixVariables, length = intTrack))
                    xUpdated.append(np.std(matrixVariables[:,0]))
                    yUpdated.append(np.std(matrixVariables[:,2]))
                    xMean.append(np.mean(matrixVariables[:,0]))
                    yMean.append(np.mean(matrixVariables[:,2]))
