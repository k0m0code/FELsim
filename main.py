...
beamline_lattice = [sec1,sec2,sec3,sec4,sec5,sec6,sec7,sec8,sec9]
beam_dist = ebeam.gen_6d_gaussian(0,[1,.1,1,0.1,1,1],5000)
...
schem.plotBeamPositionTransform(beam_dist, beamline_lattice, 13.4, shape = shape)
...
# timerd = timeit.timeit(code, number = 100000000)
# print(timerd)
# print(timerd/100000000)